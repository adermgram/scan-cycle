...
const SDGCard = ({ title, description, icon }) => (
  ...
  const sdgGoals = [
    {
      ...
      description: "Promoting sustainable practices in consumption and waste management",
    ...
    },
    {
      ...
      description: "Conserving and sustainably using marine resources",
      icon: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-full h-full">
  ...
  const features = [
    {
      ...
      description: "Easily scan items to identify recyclables",
      icon: <QrCodeIcon className="w-full h-full" />
    },
    {
      title: "Points & Leaderboards",
      description: "Compete with others and track your impact",
      icon: <TrophyIcon className="w-full h-full" />
    },
    {
      title: "Rewards & Coupons",
      description: "Earn eco-friendly rewards for your efforts",
    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-blue-50">
      ...
      <section className="relative h-screen flex items-center justify-center px-4">
        ...
        <div className="text-center z-10 max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-6xl font-bold text-gray-800 mb-6">
            Recycle Smart. <span className="text-green-600">Earn Rewards.</span> Save the Planet.
          </h1>
          <p className="text-xl text-gray-600 mb-8">
            Join the movement towards a sustainable future. Every scan counts.
          </p>
          <button className="bg-green-600 text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-green-700 transition-colors flex items-center mx-auto">
            Get Started
      ...
      <section className="py-20 px-4 bg-white/50">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">Supporting UN Sustainable Development Goals</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {sdgGoals.map((goal, index) => (
              <SDGCard key={index} {...goal} />
            ))}
          </div>
        </div>
      </section>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-xl font-semibold mb-4">EcoScan</h3>
              <p className="text-gray-400">Making recycling rewarding and fun.</p>
            </div>
            <div>
